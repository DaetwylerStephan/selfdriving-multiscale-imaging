...
static inline result_t set_profile_8MT175_50_MEn1(device_t id)
{
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {72, 69, 68, 77, 45, 53, 53, 48, 48, 0, 32, 84, 121, 112, 101, 32, 83, 0, 0, 0, 0, 0, 0, 0};
  ...
  const int8_t gear_information_PartNumber_temp[24] = {0, 54, 47, 55, 45, 49, 51, 52, 58, 49, 0, 105, 110, 32, 116, 111, 32, 98, 97, 115, 101, 41, 0, 0};
