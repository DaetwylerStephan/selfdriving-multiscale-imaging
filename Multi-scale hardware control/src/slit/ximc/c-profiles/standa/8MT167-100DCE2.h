...
static inline result_t set_profile_8MT167_100DCE2(device_t id)
{
  ...
  engine_settings.Antiplay = 28126;
  ...
  control_settings.MaxSpeed[1] = 723;
  control_settings.MaxSpeed[2] = 7234;
  ...
  const int8_t motor_information_Manufacturer_temp[16] = {77, 97, 120, 111, 110, 0, 99, 0, 111, 110, 116, 114, 111, 108, 32, 80};
  memcpy(motor_information.Manufacturer, motor_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t motor_information_PartNumber_temp[24] = {68, 67, 69, 32, 82, 69, 50, 53, 32, 51, 51, 57, 49, 53, 50, 0, 45, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.Poles = 2;
  motor_settings.Phases = 0;
  motor_settings.NominalVoltage = 24;
  motor_settings.NominalCurrent = 1.5;
  motor_settings.NominalSpeed = 9690;
  motor_settings.NominalTorque = 30.399999618530273;
  motor_settings.NominalPower = 20;
  motor_settings.WindingResistance = 1.5299999713897705;
  motor_settings.WindingInductance = 0.1860000044107437;
  motor_settings.RotorInertia = 14.699999809265137;
  motor_settings.StallTorque = 325;
  motor_settings.DetentTorque = 0;
  motor_settings.TorqueConstant = 20.799999237060547;
  motor_settings.SpeedConstant = 460;
  motor_settings.SpeedTorqueGradient = 34;
  motor_settings.MechanicalTimeConstant = 5.239999771118164;
  motor_settings.MaxSpeed = 14000;
  motor_settings.MaxCurrent = 1.5;
  motor_settings.MaxCurrentTime = 0;
  motor_settings.NoLoadCurrent = 0.04019999876618385;
  motor_settings.NoLoadSpeed = 10900;
  ...
  const int8_t encoder_information_Manufacturer_temp[16] = {77, 97, 120, 111, 110, 0, 84, 101, 99, 104, 46, 0, 0, 0, 0, 0};
  memcpy(encoder_information.Manufacturer, encoder_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t encoder_information_PartNumber_temp[24] = {69, 110, 99, 111, 100, 101, 114, 32, 77, 82, 32, 84, 121, 112, 101, 32, 77, 76, 0, 0, 0, 0, 0, 0};
  ...
  encoder_settings.SupplyVoltageMin = 4.699999809265137;
  encoder_settings.SupplyVoltageMax = 5.199999809265137;
  encoder_settings.MaxCurrentConsumption = 10;
  ...
  const int8_t gear_information_Manufacturer_temp[16] = {77, 97, 120, 111, 110, 32, 109, 111, 116, 111, 114, 32, 43, 32, 83, 116};
  memcpy(gear_information.Manufacturer, gear_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t gear_information_PartNumber_temp[24] = {49, 52, 52, 48, 50, 55, 0, 105, 108, 100, 45, 105, 110, 32, 116, 111, 32, 98, 97, 115, 101, 41, 0, 0};
