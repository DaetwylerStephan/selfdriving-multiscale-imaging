...
static inline result_t set_profile_8MID22_15_N(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 50, 50, 45, 49, 46, 53, 45, 78, 0, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  const int8_t motor_information_Manufacturer_temp[16] = {78, 77, 66, 45, 77, 65, 84, 0, 111, 110, 116, 114, 111, 108, 32, 80};
  memcpy(motor_information.Manufacturer, motor_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t motor_information_PartNumber_temp[24] = {80, 71, 49, 53, 83, 45, 68, 50, 48, 45, 86, 71, 82, 49, 65, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  motor_settings.NominalVoltage = 5;
  motor_settings.NominalCurrent = 0.20000000298023224;
  motor_settings.NominalSpeed = 0;
  motor_settings.NominalTorque = 0;
  motor_settings.NominalPower = 0;
  motor_settings.WindingResistance = 10;
