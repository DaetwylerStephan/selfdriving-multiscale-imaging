...
static inline result_t set_profile_8MRU_1WA(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 85, 45, 49, 87, 65, 0, 48, 0, 45, 54, 48, 45, 77, 69, 110, 50, 0, 0, 0, 0, 0};
  ...
  const int8_t motor_information_PartNumber_temp[24] = {83, 84, 50, 56, 49, 56, 83, 49, 48, 48, 54, 45, 66, 0, 72, 86, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NominalVoltage = 3.75;
  motor_settings.NominalCurrent = 0.6700000166893005;
  motor_settings.NominalSpeed = 0;
  motor_settings.NominalTorque = 0.061000000685453415;
  motor_settings.NominalPower = 0;
  motor_settings.WindingResistance = 5.599999904632568;
  motor_settings.WindingInductance = 4;
  motor_settings.RotorInertia = 9;
