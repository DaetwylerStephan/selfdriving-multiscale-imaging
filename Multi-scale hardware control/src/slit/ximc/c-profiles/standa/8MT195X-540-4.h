...
static inline result_t set_profile_8MT195X_540_4(device_t id)
{
  ...
  const int8_t motor_information_PartNumber_temp[24] = {83, 84, 53, 57, 49, 56, 76, 51, 48, 48, 56, 0, 48, 52, 66, 0, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {0, 69, 50, 45, 49, 54, 0, 0, 48, 0, 32, 84, 121, 112, 101, 32, 83, 0, 0, 0, 0, 0, 0, 0};
  ...
  const int8_t gear_information_PartNumber_temp[24] = {0, 54, 47, 55, 0, 49, 51, 52, 58, 49, 0, 105, 110, 32, 116, 111, 32, 98, 97, 115, 101, 41, 0, 0};
