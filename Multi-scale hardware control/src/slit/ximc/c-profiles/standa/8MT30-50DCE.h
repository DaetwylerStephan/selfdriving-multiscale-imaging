...
static inline result_t set_profile_8MT30_50DCE(device_t id)
{
  ...
  const int8_t motor_information_PartNumber_temp[24] = {68, 67, 69, 32, 82, 69, 50, 53, 32, 51, 51, 57, 49, 53, 50, 0, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NoLoadCurrent = 0.03700000047683716;
  ...
  const int8_t gear_information_PartNumber_temp[24] = {49, 52, 52, 48, 50, 55, 0, 52, 58, 49, 0, 105, 110, 32, 116, 111, 32, 98, 97, 115, 101, 41, 0, 0};
