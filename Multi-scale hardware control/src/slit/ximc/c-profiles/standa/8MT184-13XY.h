...
static inline result_t set_profile_8MT184_13XY(device_t id)
{
  ...
  const int8_t motor_information_PartNumber_temp[24] = {83, 84, 50, 48, 49, 56, 83, 48, 54, 48, 52, 0, 48, 52, 66, 0, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NominalTorque = 0.017999999225139618;
  motor_settings.NominalPower = 0;
  motor_settings.WindingResistance = 6.5;
  motor_settings.WindingInductance = 1.7000000476837158;
  motor_settings.RotorInertia = 2;
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {0, 69, 50, 45, 50, 53, 54, 0, 48, 0, 32, 84, 121, 112, 101, 32, 83, 0, 0, 0, 0, 0, 0, 0};
  ...
  const int8_t gear_information_PartNumber_temp[24] = {0, 53, 47, 56, 0, 49, 51, 52, 58, 49, 0, 105, 110, 32, 116, 111, 32, 98, 97, 115, 101, 41, 0, 0};
