...
static inline result_t set_profile_8MS00V_10_VSS43(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 83, 48, 48, 86, 45, 49, 48, 45, 86, 83, 83, 52, 51, 0, 69, 110, 50, 0, 0, 0, 0, 0};
  ...
  const int8_t motor_information_PartNumber_temp[24] = {86, 83, 83, 52, 51, 46, 50, 48, 48, 46, 49, 46, 50, 45, 72, 86, 45, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NominalTorque = 0.23499999940395355;
  motor_settings.NominalPower = 0;
  motor_settings.WindingResistance = 2.5999999046325684;
  motor_settings.WindingInductance = 5.199999809265137;
  ...
  const int8_t encoder_information_Manufacturer_temp[16] = {0, 97, 110, 111, 116, 101, 99, 0, 99, 104, 46, 0, 0, 0, 0, 0};
  memcpy(encoder_information.Manufacturer, encoder_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t encoder_information_PartNumber_temp[24] = {0, 69, 68, 76, 53, 53, 52, 49, 45, 66, 0, 84, 121, 112, 101, 32, 77, 76, 0, 0, 0, 0, 0, 0};
