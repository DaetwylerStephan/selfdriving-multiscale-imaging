...
static inline result_t set_profile_8MID98_4_90(device_t id)
{
  ...
  stage_settings.LeadScrewPitch = 31.578947067260742;
  ...
  const int8_t motor_information_PartNumber_temp[24] = {83, 84, 50, 56, 49, 56, 77, 49, 48, 48, 54, 0, 82, 49, 65, 0, 0, 0, 0, 0, 0, 0, 0, 0};
