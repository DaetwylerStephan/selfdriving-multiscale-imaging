...
static inline result_t set_profile_8MS00_25(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 83, 48, 48, 45, 50, 53, 0, 50, 56, 0, 54, 48, 45, 77, 69, 110, 50, 0, 0, 0, 0, 0};
  ...
  const int8_t motor_information_PartNumber_temp[24] = {70, 76, 52, 50, 83, 84, 72, 51, 52, 45, 48, 52, 48, 52, 66, 0, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NominalVoltage = 12;
  motor_settings.NominalCurrent = 0.4000000059604645;
  motor_settings.NominalSpeed = 0;
  motor_settings.NominalTorque = 0.25;
  motor_settings.NominalPower = 0;
  motor_settings.WindingResistance = 30;
  motor_settings.WindingInductance = 37;
  motor_settings.RotorInertia = 38;
