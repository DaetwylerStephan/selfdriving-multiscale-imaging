...
static inline result_t set_profile_8MT50Z_150BS1(device_t id)
{
  ...
  const int8_t accessories_settings_MagneticBrakeInfo_temp[24] = {66, 82, 65, 75, 69, 45, 66, 75, 69, 45, 48, 44, 52, 45, 48, 44, 53, 0, 0, 0, 0, 0, 0, 0};
  memcpy(accessories_settings.MagneticBrakeInfo, accessories_settings_MagneticBrakeInfo_temp, sizeof(int8_t) * 24);
  accessories_settings.MBRatedVoltage = 24;
  accessories_settings.MBRatedCurrent = 0.30000001192092896;
  accessories_settings.MBTorque = 40;
