...
static inline result_t set_profile_PRM1Z8(device_t id)
{
  ...
  engine_settings.Antiplay = -17380;
  ...
  control_settings.MaxSpeed[0] = 56;
  control_settings.MaxSpeed[1] = 562;
  control_settings.MaxSpeed[2] = 5624;
