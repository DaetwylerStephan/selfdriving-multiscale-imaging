...
static inline result_t set_profile_8MR191_1_4209_E4(device_t id)
{
  ...
  const int8_t motor_information_PartNumber_temp[24] = {83, 84, 52, 50, 48, 57, 83, 49, 48, 48, 54, 45, 66, 0, 72, 86, 45, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NominalVoltage = 5.630000114440918;
  motor_settings.NominalCurrent = 0.6700000166893005;
  motor_settings.NominalSpeed = 0;
  motor_settings.NominalTorque = 0.20999999344348907;
  motor_settings.NominalPower = 0;
  motor_settings.WindingResistance = 8.399999618530273;
  motor_settings.WindingInductance = 16;
  motor_settings.RotorInertia = 35;
