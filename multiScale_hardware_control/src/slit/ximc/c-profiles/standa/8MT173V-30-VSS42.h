...
static inline result_t set_profile_8MT173V_30_VSS42(device_t id)
{
  ...
  const int8_t motor_information_Manufacturer_temp[16] = {80, 104, 121, 116, 114, 111, 110, 0, 82, 0, 116, 114, 111, 108, 32, 80};
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {0, 69, 50, 45, 49, 54, 0, 32, 77, 82, 32, 84, 121, 112, 101, 32, 83, 0, 0, 0, 0, 0, 0, 0};
