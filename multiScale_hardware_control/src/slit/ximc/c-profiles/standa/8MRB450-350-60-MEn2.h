...
static inline result_t set_profile_8MRB450_350_60_MEn2(device_t id)
{
  ...
  engine_settings.Antiplay = 12160;
  ...
  const int8_t motor_information_PartNumber_temp[24] = {83, 84, 53, 57, 49, 56, 76, 51, 48, 48, 56, 0, 50, 45, 72, 86, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NominalVoltage = 3.9000000953674316;
  motor_settings.NominalCurrent = 2.119999885559082;
  motor_settings.NominalSpeed = 0;
  motor_settings.NominalTorque = 3.5399999618530273;
  motor_settings.NominalPower = 0;
  motor_settings.WindingResistance = 2.5999999046325684;
  motor_settings.WindingInductance = 12.800000190734863;
  ...
  const int8_t encoder_information_Manufacturer_temp[16] = {78, 97, 110, 111, 116, 101, 99, 0, 99, 104, 46, 0, 0, 0, 0, 0};
  memcpy(encoder_information.Manufacturer, encoder_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t encoder_information_PartNumber_temp[24] = {87, 69, 68, 76, 53, 53, 52, 49, 45, 66, 0, 84, 121, 112, 101, 32, 77, 76, 0, 0, 0, 0, 0, 0};
