...
static inline result_t set_profile_8MT160_300_MEn1(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 54, 48, 45, 51, 48, 48, 45, 77, 69, 110, 49, 0, 69, 110, 50, 0, 0, 0, 0, 0};
  ...
  stage_settings.HorizontalLoadCapacity = 10;
  ...
  const int8_t motor_information_PartNumber_temp[24] = {70, 76, 52, 50, 83, 84, 72, 52, 55, 45, 49, 50, 48, 52, 66, 0, 45, 50, 48, 48, 45, 88, 0, 0};
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {72, 69, 68, 77, 45, 53, 53, 48, 48, 0, 0, 84, 121, 112, 101, 32, 77, 76, 0, 0, 0, 0, 0, 0};
