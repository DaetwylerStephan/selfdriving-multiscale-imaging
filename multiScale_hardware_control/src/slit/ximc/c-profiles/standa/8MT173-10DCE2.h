...
static inline result_t set_profile_8MT173_10DCE2(device_t id)
{
  ...
  const int8_t motor_information_PartNumber_temp[24] = {49, 49, 56, 53, 49, 50, 0, 49, 48, 48, 54, 0, 50, 45, 72, 86, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  motor_settings.NominalVoltage = 3.5999999046325684;
  motor_settings.NominalCurrent = 0.5870000123977661;
  motor_settings.NominalSpeed = 3000;
  motor_settings.NominalTorque = 2.8499999046325684;
  motor_settings.NominalPower = 2.130000114440918;
  motor_settings.WindingResistance = 3.5;
  motor_settings.WindingInductance = 0.11400000005960464;
  motor_settings.RotorInertia = 0.5120000243186951;
  motor_settings.StallTorque = 5.099999904632568;
  motor_settings.DetentTorque = 0;
  motor_settings.TorqueConstant = 4.960000038146973;
  motor_settings.SpeedConstant = 1930;
  motor_settings.SpeedTorqueGradient = 1350;
  motor_settings.MechanicalTimeConstant = 7.21999979019165;
  motor_settings.MaxSpeed = 11000;
  motor_settings.MaxCurrent = 0;
  motor_settings.MaxCurrentTime = 0;
  motor_settings.NoLoadCurrent = 0.019200000911951065;
  motor_settings.NoLoadSpeed = 6800;
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {69, 110, 99, 111, 100, 101, 114, 32, 77, 82, 32, 84, 121, 112, 101, 32, 83, 0, 0, 0, 0, 0, 0, 0};
  ...
  encoder_settings.SupplyVoltageMin = 2.700000047683716;
  encoder_settings.SupplyVoltageMax = 5.5;
  ...
  const int8_t gear_information_Manufacturer_temp[16] = {77, 97, 120, 111, 110, 32, 109, 111, 116, 111, 114, 0, 43, 32, 83, 116};
  memcpy(gear_information.Manufacturer, gear_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t gear_information_PartNumber_temp[24] = {49, 49, 48, 51, 49, 53, 0, 105, 108, 100, 45, 105, 110, 32, 116, 111, 32, 98, 97, 115, 101, 41, 0, 0};
  ...
  gear_settings.InputInertia = 0.014999999664723873;
  gear_settings.Efficiency = 75;
