...
static inline result_t set_profile_8MT50_100BS1_MEn1(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 53, 48, 45, 49, 48, 48, 66, 83, 49, 45, 77, 69, 110, 49, 0, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.VerticalLoadCapacity = 8;
  ...
  const int8_t motor_information_PartNumber_temp[24] = {70, 76, 52, 50, 83, 84, 72, 52, 55, 45, 49, 50, 48, 52, 66, 0, 0, 50, 48, 48, 45, 88, 0, 0};
