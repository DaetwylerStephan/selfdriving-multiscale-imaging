...
static inline result_t set_profile_8MR190_2_DCE(device_t id)
{
  ...
  engine_settings.Antiplay = -30364;
  ...
  control_settings.MaxSpeed[0] = 63;
  control_settings.MaxSpeed[1] = 631;
  control_settings.MaxSpeed[2] = 6313;
